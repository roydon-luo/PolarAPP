...
python infer.py --input-dir ./Datasets/Testsets \
  --ckpt-dir ./experiments/checkpoints --device cuda:0
```
...
evaluation, checkpoint discovery, release audit, and smoke tests are included.
Numerical reproduction of the paper tables additionally requires the authors'
pretrained checkpoints. Exact paper runs used Python 3.10, Adam with learning
rate `5e-5`, and NVIDIA RTX 4090 GPUs; task-specific weights are documented in
the corresponding configuration and README.
