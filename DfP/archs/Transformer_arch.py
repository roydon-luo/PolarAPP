...
class Transformer(nn.Module):
    ...
    def forward(self, inp_img, prior=None):
        ...
        out_dec_level1_out=out_dec_level1
        ...
        taskfeat = {}
        taskfeat['TaF3'] = out_dec_level3
        taskfeat['TaF2'] = out_dec_level2
        taskfeat['TaF1'] = out_dec_level1_out

        return out_dec_level1,taskfeat
